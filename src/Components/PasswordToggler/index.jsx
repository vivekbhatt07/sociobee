...
const PasswordToggler = (props) => {
  ...
  return (
    <div className={classes}>
      {children}
      <button
        className=" absolute z-10 p-2 right-2 top-[6px] w-8 h-8 rounded-full flex justify-center items-center transition-all duration-300 hover:bg-stone-300 dark:text-stone-950"
        type="button"
        onClick={(event) => {
